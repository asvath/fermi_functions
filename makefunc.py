...
import cfg
import os, sys
#this function corrects the path of the diffuse source. #It also adds in your source.
def makexmlfunc(healpix,ra,dec,week1,week2,distance):
	...
	with open (makexmllog,'r') as outputFile: #opens the makexmllog file from makesyfunc. This document contains info about the extended source/
